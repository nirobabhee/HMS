...
//         Route::post('nurse/store', 'NurseController@store')->name('nurse.store');
//         Route::get('nurse/edit/{id}', 'NurseController@edit')->name('nurse.edit');
//         Route::post('nurse/update/{id}', 'NurseController@update')->name('nurse.update');
//         Route::post('nurse/activate', 'NurseController@activate')->name('nurse.activate');
//         Route::post('nurse/deactivate', 'NurseController@deactivate')->name('nurse.deactivate');
//          //Pharmacist
//         Route::get('pharmacist/index', 'PharmacistController@index')->name('pharmacist.index');
//         Route::get('pharmacist/create', 'PharmacistController@create')->name('pharmacist.create');
//         Route::post('pharmacist/store', 'PharmacistController@store')->name('pharmacist.store');
//         Route::get('pharmacist/edit/{id}', 'PharmacistController@edit')->name('pharmacist.edit');
//         Route::post('pharmacist/update/{id}', 'PharmacistController@update')->name('pharmacist.update');
//         Route::post('pharmacist/activate', 'PharmacistController@activate')->name('pharmacist.activate');
//         Route::post('pharmacist/deactivate', 'PharmacistController@deactivate')->name('pharmacist.deactivate');
//          //Laboratorist
