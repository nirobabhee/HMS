...
class ForgotPasswordController extends Controller
{
    ...
    public function sendResetCodeEmail(Request $request)
    {
        ...
        $adminPasswordReset = new DoctorPasswordReset();
        ...
        return view('doctor.auth.passwords.code_verify', compact('pageTitle', 'notify'));
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return redirect()->route('doctor.password.reset.form', $code)->withNotify($notify);
    }
}
