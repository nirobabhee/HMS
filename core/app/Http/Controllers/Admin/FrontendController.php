...
class FrontendController extends Controller
{
    ...
    public function siteInfoEdit()
    {
        ...
        $site = Frontend::where('data_keys', 'site.data')->first();
        if(!$site){
            $data_values = '{"site_title":"WEBSITENAME", "site_slogan":"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit","email":"demo@gmail.com","phone":"9961245778", "mobile":"0154789645","country":"USA", "city":"Washington DC", "state":"ddfgf","zip":"124578","description":"uisadffufjf"}';
            $data_values = json_decode($data_values, true);
            $frontend = new Frontend();
            $frontend->data_keys = 'site.data';
            $frontend->data_values = $data_values;
            $frontend->save();
        }
        return view('admin.frontend.site_information', compact('pageTitle', 'site'));
    }
