...
class AdminController extends Controller
{
    ...
    public function createAdminForm()
    {
        ...
        $emptyMessage = 'No admin create yet';
        return view('admin.index', compact('pageTitle', 'admins','emptyMessage'));
    }
    public function adminStore(Request $request)
    {
        ...
        $admin->save();
        $notify[] = ['success', 'New admin has been created.'];
    ...
    public function adminUpdate(Request $request, $id)
    {
        ...
        $admin->password = bcrypt($request->password);
        $admin->save();
        $notify[] = ['success', 'Admin has been updated.'];
        return redirect()->route('admin.index')->withNotify($notify);
    }
    public function adminDelete(Request $request)
    {
        Admin::findOrFail($request->id)->delete();
        $notify[] = ['success', 'Admin has been Deleted.'];
        return redirect()->route('admin.index')->withNotify($notify);
    }
