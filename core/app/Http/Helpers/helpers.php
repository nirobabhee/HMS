...
function imagePath()
{
    ...
    $data['profile'] = [
        ...
        'doctor_assistant' => [
            'path' => 'assets/doctor_assistant/images/profile',
            'size' => '400x400'
        ],
        'laboratorist' => [
            'path' => 'assets/laboratorist/images/profile',
            'size' => '400x400'
        ],
        'accountant' => [
            'path' => 'assets/accountant/images/profile',
            'size' => '400x400'
        ],
        'receptionist' => [
            'path' => 'assets/receptionist/images/profile',
            'size' => '400x400'
        ]
    ];
    return $data;
