                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary align-items-center">
                        <div class="avatar avatar--lg">
                            <img src="{{ getImage(imagePath()['profile']['doctor']['path'].'/'. $doctor->image,imagePath()['profile']['doctor']['size'])}}" alt="@lang('Image')">
                        </div>
                        <div class="pl-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Name')
                            <span class="font-weight-bold">{{__($doctor->name)}}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Username')
                            <span  class="font-weight-bold">{{__($doctor->username)}}</span>
                        </li>
                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url({{ getImage(imagePath()['profile']['doctor']['path'].'/'.auth()->guard('doctor')->user()->image,imagePath()['profile']['doctor']['size']) }})">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="name" value="{{ auth()->guard('doctor')->user()->name }}" >
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold">@lang('Email')</label>
                                    <input class="form-control" type="email" name="email" value="{{ auth()->guard('doctor')->user()->email }}" >
                                </div>
                            </div>
