...
@section('content')
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets/doctor/images/1.jpg')}}">
            <div class="form-wrapper">
                ...
                <form action="{{ route('doctor.login') }}" method="POST" class="cmn-form mt-30">
                    @csrf
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center">
                        <a href="{{ route('doctor.password.reset') }}" class="text-muted text--small"><i class="las la-lock"></i>@lang('Forgot password?')</a>
                    </div>
                    <div class="form-group">
