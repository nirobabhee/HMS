    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                @if(Auth::guard('admin')->id() == $super_admin->id)
                <li class="sidebar-menu-item {{menuActive('admin.index')}}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.doctor*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.doctor.assistant.index')}} ">
                                <a href="{{route('admin.doctor.assistant.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.users*',3)}}">
                        ...
                        <span class="menu-title">@lang('Manage Patients')</span>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('admin.users.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Patients')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.users.create')}} ">
                                <a href="{{route('admin.users.create')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add Patient')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.user.documents')}} ">
                                <a href="{{route('admin.user.documents')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Patient Documents')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.active')}} ">
                                <a href="{{route('admin.users.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Patients')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.users.banned')}} ">
                                <a href="{{route('admin.users.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Patients')</span>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.doctor.schedule*',3)}}">
                        <i class="menu-icon las la-calendar-check"></i>
                        <span class="menu-title">@lang('Schedule')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.doctor.schedule*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.schedule.slot')}} ">
                                <a href="{{route('admin.schedule.slot')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Slot')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.doctor.schedule*')}} ">
                                <a href="{{route('admin.doctor.schedule.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.appointment*',3)}}">
                        ...
                        @if($pending_appointment_count > 0 )
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.appointment*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.appointment.create')}} ">
                                <a href="{{route('admin.appointment.create')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add Appointment')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.appointment.index')}} ">
                                <a href="{{route('admin.appointment.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Appointments')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.appointment*',2)}} ">
                                <a href="{{route('admin.appointment.assign',[1,'Admin'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Assign By Admin ')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.appointment*',2)}} ">
                                <a href="{{route('admin.appointment.assign',[2,'Doctor'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Assign By Doctor')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.appointment*',2)}} ">
                                <a href="{{route('admin.appointment.assign',[3,'Receptionist'])}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Assign By Receptionist')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <!--Prescription-->
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.prescription*',3)}}">
                        <i class="menu-icon las la-book-reader"></i>
                        <span class="menu-title">@lang('Prescription')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.prescription*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.prescription.create*',2)}} ">
                                <a href="{{route('admin.prescription.create')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add Prescription')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.prescription.index*',2)}} ">
                                <a href="{{route('admin.prescription.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Prescription List')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.prescription.case.studies.index')}} ">
                                <a href="{{route('admin.prescription.case.studies.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Patient Case Study List')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.laboratorist.index')}}">
                    <a href="{{route('admin.laboratorist.index')}}" class="nav-link ">
                        <i class="menu-icon las la-flask"></i>
                        <span class="menu-title">@lang('Laboratorist')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.accountant.index')}}">
                    <a href="{{route('admin.accountant.index')}}" class="nav-link ">
                        <i class="menu-icon las la-money-bill-alt"></i>
                        <span class="menu-title">@lang('Accountant')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.receptionist.index')}}">
                    <a href="{{route('admin.receptionist.index')}}" class="nav-link ">
                        <i class="menu-icon las la-bell"></i>
                        <span class="menu-title">@lang('Receptionist')</span>
                    </a>
                </li>
                {{-- Noticeboard --}}
                <li class="sidebar-menu-item {{menuActive('admin.noticeboard.index')}}">
                    <a href="{{route('admin.noticeboard.index')}}" class="nav-link ">
                        <i class="menu-icon las la-user-clock"></i>
                        <span class="menu-title">@lang('Noticeboard')</span>
                        @if($upcoming_notice_count)
                        <span  class="menu-badge pill bg--primary ml-auto">{{$upcoming_notice_count}}</span>
                        @endif
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.site')}}">
                    <a href="{{route('admin.site')}}" class="nav-link">
                        <i class="menu-icon las la-atlas"></i>
                        <span class="menu-title">@lang('Site Information')</span>
                    </a>
                </li>
