...
@section('panel')
    <div class="row mb-none-30">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.doctor.assistant.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="thumb">
                                <div class="avatar-preview">
                                    <div class="profilePicPreview"
                                        style="background-image: url({{ getImage('', imagePath()['profile']['doctor_assistant']['size']) }})">
